// https://raw.githubusercontent.com/lazaronixon/trix-extensions/master/assets/stylesheets/richtext.scss
...
addEventListener('trix-action-invoke', (event) => {
  const buildHorizontalRule = () => new Trix.Attachment({ content: '<hr>', contentType: 'vnd.rubyonrails.horizontal-rule.html' })
  const insertHorizontalRule = () => event.target.editor.insertAttachment(buildHorizontalRule())
...
const addForegroundColorAttributes = () => {
...
const addBackgroundColorAttributes = () => {
